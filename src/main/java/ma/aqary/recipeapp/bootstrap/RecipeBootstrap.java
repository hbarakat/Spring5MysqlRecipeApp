package ma.aqary.recipeapp.bootstrap;

import lombok.extern.slf4j.Slf4j;
import ma.aqary.recipeapp.domain.*;
...
private final RecipeRepository recipeRepository;
   ...
   @Transactional
    ...
    //getUoMs
    //get UOMs
    Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByDescription("Gr");

    if(!eachUomOptional.isPresent()){
        throw new RuntimeException("Expected UOM Not Found");
    }

    Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Cup");

    if(!tableSpoonUomOptional.isPresent()){
        throw new RuntimeException("Expected UOM Not Found");
    }

    Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Ml");
    ...
    UnitOfMeasure dashUom = ounceUomOptional.get();

    //get Categories
    Optional<Category> moroccanCategoryOptional = categoryRepository.findByDescription("Moroccan");

    if(!moroccanCategoryOptional.isPresent()){
    ...
    Category moroccanCategory = moroccanCategoryOptional.get();
    ...
    guacRecipe.setSource("atlas Taste");
    guacRecipe.setUrl("http://www.atlastaste.com");
    ...
    guacRecipe.getCategories().add(moroccanCategory);
    ...
    tacosRecipe.setSource("atlas Taste");
    tacosRecipe.setUrl("http://www.atlastaste.com");
    ...
    tacosRecipe.addIngredient(new Ingredient("packed baby arugula", new BigDecimal(3), tableSpoonUom));
    tacosRecipe.addIngredient(new Ingredient("medium ripe avocados, slic", new BigDecimal(2), eachUom));
    tacosRecipe.addIngredient(new Ingredient("radishes, thinly sliced", new BigDecimal(4), eachUom));
    tacosRecipe.addIngredient(new Ingredient("cherry tomatoes, halved", new BigDecimal(".5"), tableSpoonUom));
    tacosRecipe.addIngredient(new Ingredient("red onion, thinly sliced", new BigDecimal(".25"), eachUom));
    tacosRecipe.addIngredient(new Ingredient("Roughly chopped cilantro", new BigDecimal(4), eachUom));
    tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), tableSpoonUom));
    tacosRecipe.addIngredient(new Ingredient("lime, cut into wedges", new BigDecimal(4), eachUom));

    tacosRecipe.getCategories().add(moroccanCategory);
