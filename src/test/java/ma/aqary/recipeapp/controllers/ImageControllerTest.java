...
import ma.aqary.recipeapp.services.ImageService;
...
class ImageControllerTest {
    ...
    public void renderImageFromDB() throws Exception {
        ...
        Byte[] givenBytes=new Byte[s.getBytes().length];
        int i=0;
        for(byte primByte:s.getBytes()){
            givenBytes[i++]=primByte;
        }
        recipeCommand.setImage(givenBytes);
        //When
    ...
    void getRecipeByIdNumberFormatExceptionTest() throws Exception {
        mockMvc.perform(get("/recipe/1s/recipeimage"))
